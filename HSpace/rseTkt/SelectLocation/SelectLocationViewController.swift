...
extension SelectLocationViewController: UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
      let cell = locationsTableView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! LocationCellRpt
...
extension SelectLocationViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell") as! SublocationCellRpt
...
class LocationCellRpt: UICollectionViewCell, ReusableView {
    @IBOutlet weak var locationImageView: UIImageView!
    @IBOutlet weak var locationNameLabel: UILabel!
    @IBOutlet weak var overlayView: UIView!
}

class SublocationCellRpt: UITableViewCell, ReusableView {
