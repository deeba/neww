...
public class FloatingLabelInput: UITextField {
    ...
    var paddingHeight:CGFloat                               = 10.0
    ...
    public var paddingYFloatLabel:CGFloat = 13.0{
    ...
    override public func layoutSubviews() {
        ...
        lblFloatPlaceholder.textColor = .black
