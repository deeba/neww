...
class PausWOViewController:  UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
   
    @IBOutlet weak var collectionViewPaus: UICollectionView!
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
               ...
               return    self.indexPaus
           }
           func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
               if indexPath.row == pausOMdl.DisNm.count - 1
               {

                   TblOrderPaus(Tkn: tknz)
               }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        collectionViewPaus.dataSource = self
        collectionViewPaus.delegate = self
        ...
        instanceOfUser.writeAnyData(key: "offsetzTblPaus", value: 0)
        TblOrderPaus(Tkn: tknz)
        ...
        @objc func loadTbl()
        {
            self.collectionViewPaus.reloadData()
        }
          func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
            ...
            func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
               //print(pausOMdl.QRcdeTbl[indexPath.row])
            }
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cellPaus", for: indexPath) as! PausWOCollectionViewCell
            cell.disNamePaus.text = pausOMdl.DisNm[indexPath.row]
               cell.tmNamPaus.text = pausOMdl.TmNam[indexPath.row]
            cell.eqpNamPaus.text = pausOMdl.EqNam[indexPath.row]  + "  " +  pausOMdl.Caus[indexPath.row]
               // cell.causDn.text = CausDn[indexPath.row] as? String
                let message: String = pausOMdl.EqLcn[indexPath.row]
               //set the text and style if any.
                cell.eqpLcnPaus.text = message
               let prioriti: String = pausOMdl.Prioritz[indexPath.row]
               if(prioriti == "0"){
                   cell.imgSttsPaus.image = UIImage(named: "Rectangle 15-2")
                   cell.lblSttsPaus.text = "Low"
                   }
               if(prioriti == "1"){
                   cell.imgSttsPaus.image = UIImage(named: "Rectangle 15-3")
                   cell.lblSttsPaus.text = "Normal"
               }
               if(prioriti == "2"){
                   cell.imgSttsPaus.image = UIImage(named: "Rectangle 15-1")
                   cell.lblSttsPaus.text? = "High"
               }
               if(prioriti == "3"){
                   cell.imgSttsPaus.image = UIImage(named: "Rectangle 15-4")
                   cell.lblSttsPaus.text? = "Breakdown"
               }
            let chkdTim  = pausOMdl.dtSchedule[indexPath.row]
            let dateFormatter = DateFormatter()
              ...
              if(Int(distanceBetweenDates!)
               > 0){
                  cell.imgTimPaus.image = UIImage(named: "Group-13")
              }
              else
              {
                cell.imgTimPaus.image = UIImage(named: "Group-14")
              }
         cell.lblTimPaus?.text = timeString(time: TimeInterval(abs(secbetweenDates)))
                                       ...
                                       var  display_namey: String = "",chkList:[Int] =  Array(), statey: String = "",Statuzy: Bool  = false, boolzy: Bool  = false, boolz1y: Bool  = false,mAssignedByy: String = "",MtTm_idy: String = "" , causey: String = "", type_categoryy: String = "", equipment_location_namy: String = "", priorityy: String = "",  mCompanyNamy: String = "", maintenance_team_idy: String = "", TmId: String = "", date_start_scheduled: String = "",company_id: String = "",stringFields: String = "",equipment_namy: String = "", Idy: Int = 0,strSelectdReasony: String = "", strReasony: String = "", strReasonIdy: String = "",hlpDskId_idy: String = "", enforce_timey: Bool  = false,at_start_mroy: Bool  = false, at_done_mroy: Bool  = false, at_review_mroy: Bool  = false,mStarttmy: String = "", mEndtmy: String = "",mExetmy: String = "",MsgIds:[Int] =  Array(),strMsgIdsy: String = "",date_scheduledy: String = "",maintenance_typey: String = "",strchkListy: String = "", mAssignedToy: String = "",mAssetNamy: String = "",mAssetIdy: String = "", QRcdey: String = "",equipment_idy: String = "", equipment_seqy: String = "",equipment_location_id: String = ""
                                        ...
                                        TmId = self.instanceOfUser.readStringData(key: "MTmId")
                                                               ...
                                                               let stringFields1 = """
                                                                                                                   ...
                                                                                                                   MtTmId = Int(TmId) ?? 0
                                                                                                                   let  stringFields2 = """
                                                                                                                   ],"|","|",["state","=","pause"],["state","=","pause"],["state","=","pause"]]
                                                                                                                   """
                                                                                                               ...
                                                                                                               let stringOff = instanceOfUser.readIntData(key:  "offsetzTblPaus")
                                               ...
                                               //      for i in 0..<lngth.intValue {
                                                 ...
                                                 if title[i]["equipment_location_id"].stringValue == "false"
                                                   ...
                                                   if title[i]["type_category"].stringValue == "equipment"
                                                   {
                                                    ...
                                                    pausOMdl.DisNm.append(display_namey)
                                                      pausOMdl.TmNam.append(tmIid)
                                                      pausOMdl.EqNam.append(equipment_namy)
                                                      pausOMdl.Caus.append(causey)
                                                    
                                                      pausOMdl.EqLcn.append(equipment_location_namy)
                                                     pausOMdl.Prioritz.append(priorityy)
                                                     pausOMdl.dtSchedule.append(title[i]["date_scheduled"].stringValue)
                                                     pausOMdl.dtExecnPaus.append(mExetmy)
                                                     self.indexPaus = self.indexPaus + 1
                                                     self.totalPaus = self.totalPaus  + 1
                                                     var boolz: Bool
                                                                                                    boolz =  false
                                                                                               mAssignedByy = ""
                                                                                               ...
                                                                                               if title[i]["pause_reason_id"].stringValue == "false"
                                                                                                     ...
                                                                                                     if statey == "draft"
                                                                                                   {
                                                                                                      ...
                                                                                                      pausOMdl.idTbl.append(Idy)
                                                                                                      pausOMdl.display_nameTbl.append(display_namey)
                                                                                                      pausOMdl.causeTbl.append(causey)
                                                                                                      pausOMdl.mAssignedByTbl.append(mAssignedByy)
                                                                                                      pausOMdl.date_scheduledTbl.append(date_scheduledy)
                                                                                                      pausOMdl.stateTbl.append(statey)
                                                                                                      pausOMdl.type_categoryTbl.append(type_categoryy)
                                                                                                      pausOMdl.equipment_location_namTbl.append(equipment_location_namy)
                                                                                                      pausOMdl.priorityTbl.append(priorityy)
                                                                                                      pausOMdl.mAssignedToTbl.append(mAssignedToy)
                                                                                                      pausOMdl.mAssetNamTbl.append(mAssetNamy)
                                                                                                      pausOMdl.maintenance_typeTbl.append(maintenance_typey)
                                                                                                      pausOMdl.mStarttmTbl.append(mStarttmy)
                                                                                                      pausOMdl.mEndtmTbl.append(mEndtmy)
                                                                                                      pausOMdl.StatuzTbl.append(Statuzy)
                                                                                                      pausOMdl.boolz1Tbl.append(boolz)
                                                                                                      pausOMdl.boolz2Tbl.append(boolz)
                                                                                                      pausOMdl.mCompanyNamTbl.append(mCompanyNamy)
                                                                                                      pausOMdl.strchkListTbl.append(strchkListy)
                                                                                                      pausOMdl.mAssetIdTbl.append(mAssetIdy)
                                                                                                      pausOMdl.QRcdeTbl.append(QRcdey)
                                                                                                      pausOMdl.strMsgIdsTbl.append(strMsgIdsy)
                                                                                                      pausOMdl.at_start_mroTbl.append(at_start_mroy)
                                                                                                      pausOMdl.at_done_mroTbl.append(at_done_mroy)
                                                                                                      pausOMdl.at_review_mroTbl.append(at_review_mroy)
                                                                                                      pausOMdl.maintenance_team_idTbl.append(maintenance_team_idy)
                                                                                                      pausOMdl.hlpDskId_idTbl.append(hlpDskId_idy)
                                                                                                      pausOMdl.enforce_timeTbl.append(enforce_timey)
                                                                                                      pausOMdl.boolz3Tbl.append(boolz)
                                                                                                      pausOMdl.strReasonTbl.append(strReasony)
                                                                                                      pausOMdl.strReasonIdTbl.append(strReasonIdy)
                                                                                                      pausOMdl.strSelectdReasonTbl.append(strSelectdReasony)
 ...
 */
                                                  self.instanceOfUser.writeAnyData(key: "offsetzTblPaus", value: self.instanceOfUser.readIntData(key:  "offsetzTblPaus") + 20)
    ...
    {//5S
       /* if let strings =
        ...
        for j in 0..<pausOMdl.idTbl.count {
                let dispnam = pausOMdl.display_nameTbl[j]
                let stringFields1 = """
                                                          &fields=["mro_activity_id","id","answer_type","answer_common","mro_quest_grp_id","value_suggested_ids"]&ids=
                                                          """
                                                          var   trimmed1  : String
                                                           trimmed1 = pausOMdl.strchkListTbl[j]
    ...
    func insertTblOrders()
    {
       /* if let strings =
        ...
        for i in 0..<pausOMdl.idTbl.count {
            
                        var isFlg: String = ""
                                if  pausOMdl.stateTbl[i] == "in_progress"
                                    {
                                    isFlg = "1"
                                    }
                                    else if  pausOMdl.stateTbl[i] == "pause"
                                    {
                                    isFlg = "2"
                                    }
                                    else if  pausOMdl.stateTbl[i] == "done"
                                    {
                                    isFlg = "3"
                                    }
                                    else
            ...
            else
            {
               ...
               var queryStatement: OpaquePointer?
            let unqId: Int = pausOMdl.idTbl[i]
               // 1
               if sqlite3_prepare_v2(db, queryStatementString, -1, &queryStatement, nil) ==
                   SQLITE_OK {
                sqlite3_bind_int(queryStatement, 1,(Int32(unqId)))
                 ...
                 if sqlite3_step(queryStatement) == SQLITE_ROW {
                    ...
                    let rvw: Int
                    if pausOMdl.at_review_mroTbl[i]{
                    rvw = 1
                        }
                    else {
                    rvw = 0
                 ...
                 if sqlite3_prepare_v2(db, updateStatementString, -1, &updateStatement, nil) ==
                     ...
                     // 3
                     sqlite3_bind_text(updateStatement, 1, (pausOMdl.display_nameTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 2,(pausOMdl.causeTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 3,(pausOMdl.mAssignedByTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 4,(pausOMdl.date_scheduledTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 5,(pausOMdl.stateTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 6,(pausOMdl.type_categoryTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 7,(pausOMdl.equipment_location_namTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 8,(pausOMdl.priorityTbl[i] as NSString).utf8String, -1, nil)
                    
                    sqlite3_bind_text(updateStatement, 9,(pausOMdl.mAssignedToTbl[i] as NSString).utf8String, -1, nil)
                    sqlite3_bind_text(updateStatement, 10,(pausOMdl.mAssetNamTbl[i] as NSString).utf8String, -1, nil)
                    
                     sqlite3_bind_text(updateStatement, 11, (pausOMdl.maintenance_typeTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 12,(pausOMdl.mStarttmTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 13,(pausOMdl.mEndtmTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 14,(pausOMdl.strchkListTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 15,(pausOMdl.mAssetIdTbl[i] as NSString).utf8String, -1, nil)
                    ...
                    sqlite3_bind_text(updateStatement, 19,(pausOMdl.mCompanyNamTbl[i] as NSString).utf8String, -1, nil)
                    sqlite3_bind_text(updateStatement, 20,(pausOMdl.QRcdeTbl[i] as NSString).utf8String, -1, nil)
                    sqlite3_bind_text(updateStatement, 21,(pausOMdl.strMsgIdsTbl[i] as NSString).utf8String, -1, nil)
                     ...
                     sqlite3_bind_text(updateStatement, 25,(pausOMdl.maintenance_team_idTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 26,(pausOMdl.hlpDskId_idTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_int(updateStatement, 27,Int32(enfrce))
                     sqlite3_bind_text(updateStatement, 28,(pausOMdl.strReasonTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 29,(pausOMdl.strReasonIdTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(updateStatement, 30,(pausOMdl.strSelectdReasonTbl[i] as NSString).utf8String, -1, nil)
                 ...
                 //   print("\(catid) | \(catSubid)")
                   ...
                   if sqlite3_prepare_v2(db, insertStatementString, -1, &insertStatement, nil) ==
                       SQLITE_OK {
                     // 3
                     sqlite3_bind_int(insertStatement, 1,(Int32(pausOMdl.idTbl[i])))
                     sqlite3_bind_text(insertStatement, 2, (pausOMdl.display_nameTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 3,(pausOMdl.causeTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 4,(pausOMdl.mAssignedByTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 5,(pausOMdl.date_scheduledTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 6,(pausOMdl.stateTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 7,(pausOMdl.type_categoryTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 8,(pausOMdl.equipment_location_namTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 9,(pausOMdl.priorityTbl[i] as NSString).utf8String, -1, nil)
                    
                    sqlite3_bind_text(insertStatement, 10,(pausOMdl.mAssignedToTbl[i] as NSString).utf8String, -1, nil)
                    sqlite3_bind_text(insertStatement, 11,(pausOMdl.mAssetNamTbl[i] as NSString).utf8String, -1, nil)
                    
                     sqlite3_bind_text(insertStatement, 12, (pausOMdl.maintenance_typeTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 13,(pausOMdl.mStarttmTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 14,(pausOMdl.mEndtmTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 15,(pausOMdl.strchkListTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 16,(pausOMdl.mAssetIdTbl[i] as NSString).utf8String, -1, nil)
                    ...
                    sqlite3_bind_text(insertStatement, 20,(pausOMdl.mCompanyNamTbl[i] as NSString).utf8String, -1, nil)
                    sqlite3_bind_text(insertStatement, 21,(pausOMdl.QRcdeTbl[i] as NSString).utf8String, -1, nil)
                    sqlite3_bind_text(insertStatement, 22,(pausOMdl.strMsgIdsTbl[i] as NSString).utf8String, -1, nil)
                     ...
                     sqlite3_bind_text(insertStatement, 26,(pausOMdl.maintenance_team_idTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 27,(pausOMdl.hlpDskId_idTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_int(insertStatement, 28,Int32(enfrce))
                     sqlite3_bind_text(insertStatement, 29,(pausOMdl.strReasonTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 30,(pausOMdl.strReasonIdTbl[i] as NSString).utf8String, -1, nil)
                     sqlite3_bind_text(insertStatement, 31,(pausOMdl.strSelectdReasonTbl[i] as NSString).utf8String, -1, nil)
