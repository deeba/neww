//
//  rprtRedesignViewController.swift
//  HSpace
//
//  Created by DEEBA on 31.08.20.
...
class rprtRedesignViewController: UIViewController {
...
extension rprtRedesignViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell") as! SublocationCellRed
...
extension rprtRedesignViewController: UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
      let cell = locationsTableView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! LocationCellRed
...
class LocationCellRed: UICollectionViewCell, ReusableView {
    @IBOutlet weak var locationImageView: UIImageView!
    @IBOutlet weak var locationNameLabel: UILabel!
    @IBOutlet weak var overlayView: UIView!
}

class SublocationCellRed: UITableViewCell, ReusableView {
